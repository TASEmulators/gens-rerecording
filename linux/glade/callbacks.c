...
//	if ((Check_If_Kaillera_Running())) return 0;
	...
	Pre_Load_Rom(HWnd, Recent_Rom[GPOINTER_TO_INT(user_data)]);
	sync_gens_ui();
}
                                        ...
                                        gpointer         user_data)
{
		...
		if (Net_Play)
		{
			if (Full_Screen) Set_Render(HWnd, 0, -1, 1);
		}
		Free_Rom(Game);
}
...
on_netplay_activate                    (GtkMenuItem     *menuitem,
                                        gpointer         user_data)
{
	MessageBox(HWnd, "Net Play unavailable\nsince Kaillera sources are not released.", "Net Play Unavailable", 0);
}
...
{
	if (Full_Screen) Set_Render(HWnd, 0, -1, 1);
	else Set_Render(HWnd, 1, Render_FS, 1);
}
...
on_normal_activate                     (GtkMenuItem     *menuitem,
                                        gpointer         user_data)
{
	Set_Render(HWnd, Full_Screen, 0, 0);
}
...
on_double_activate                     (GtkMenuItem     *menuitem,
                                        gpointer         user_data)
{
	Set_Render(HWnd, Full_Screen, 1, 0);
}
...
on_interpolated_activate               (GtkMenuItem     *menuitem,
                                        gpointer         user_data)
{
	Set_Render(HWnd, Full_Screen, 2, 0);
}
...
on_scanline_activate                   (GtkMenuItem     *menuitem,
                                        gpointer         user_data)
{
	Set_Render(HWnd, Full_Screen, 3, 0);
}
...
on_50_scanline_activate                (GtkMenuItem     *menuitem,
                                        gpointer         user_data)
{
	Set_Render(HWnd, Full_Screen, 4, 0);
}
...
on_25_scanline_activate               (GtkMenuItem     *menuitem,
                                        gpointer         user_data)
{
	Set_Render(HWnd, Full_Screen, 5, 0);
...
on_interpolated_scanline_activate      (GtkMenuItem     *menuitem,
                                        gpointer         user_data)
{
	Set_Render(HWnd, Full_Screen, 6, 0);
...
on_interpolated_50_scanline_activate   (GtkMenuItem     *menuitem,
                                        gpointer         user_data)
{
	Set_Render(HWnd, Full_Screen, 7, 0);
...
on_interpolated_25_scanline_activate   (GtkMenuItem     *menuitem,
                                        gpointer         user_data)
{
	Set_Render(HWnd, Full_Screen, 8, 0);
...
on_2xsai_kreed_activate                (GtkMenuItem     *menuitem,
                                        gpointer         user_data)
{
	Set_Render(HWnd, Full_Screen, 9, 0);
...
{
  GSList **headp = data;
  *headp = g_slist_prepend (*headp, iter);
}
*/
                                        ...
                                        gpointer         user_data)
{
	...
	Controller_1_Type = gtk_option_menu_get_history(GTK_OPTION_MENU(port1)) & 1;
	Controller_1_Type <<= 4;

	Controller_1_Type |= gtk_option_menu_get_history(GTK_OPTION_MENU(padp1)) & 1;
	Controller_1B_Type = gtk_option_menu_get_history(GTK_OPTION_MENU(padp1b)) & 1;
	Controller_1C_Type = gtk_option_menu_get_history(GTK_OPTION_MENU(padp1c)) & 1;
	Controller_1D_Type = gtk_option_menu_get_history(GTK_OPTION_MENU(padp1d)) & 1;

	Controller_2_Type = gtk_option_menu_get_history(GTK_OPTION_MENU(port2)) & 1;
	Controller_2_Type <<= 4;

	Controller_2_Type |= gtk_option_menu_get_history(GTK_OPTION_MENU(padp2)) & 1;
	Controller_2B_Type = gtk_option_menu_get_history(GTK_OPTION_MENU(padp2b)) & 1;
	Controller_2C_Type = gtk_option_menu_get_history(GTK_OPTION_MENU(padp2c)) & 1;
	Controller_2D_Type = gtk_option_menu_get_history(GTK_OPTION_MENU(padp2d)) & 1;
