...
#include "M68KD.h"
#include "..\core\cpu\z80\Cpu_z80.h"
#include "..\core\cpu\z80\z80.h"
#include "z80dis.h"
#include "..\core\cpu\sh2\Cpu_SH2.h"
#include "..\core\cpu\sh2\SH2.h"
#include "SH2D.h"
#include "..\core\mem\mem_M68K.h"
#include "..\core\mem\mem_S68K.h"
#include "..\core\mem\mem_Z80.h"
#include "..\core\mem\mem_SH2.h"
#include "..\core\vdp\vdp_io.h"
#include "..\core\vdp\vdp_rend.h"
#include "..\core\vdp\vdp_32X.h"
#include "..\segacd\LC89510.h"
#include "..\segacd\cd_aspi.h"
#include "..\core\gfx\gfx_cd.h"
...
void Refresh_M68k_Inst(void)
{
	...
	Print_Text(Str_Tmp, 22, 24, 1, VERT);
...
void Refresh_SH2_Inst(int num)
{
	...
	if (num)
	{
		...
		Print_Text(Str_Tmp, 21, 24, 1, VERT);
		sh = &S_SH2;
	}
	else
	{
...
void Refresh_M68k_Mem(void)
{
	...
	Print_Text(Str_Tmp, 20, 24, 130, VERT);
...
void Refresh_S68k_Mem(void)
{
	...
	Print_Text(Str_Tmp, 19, 24, 130, VERT);
...
void Refresh_M68k_State(void)
{
	...
	Print_Text(Str_Tmp, 23, 196, 130, VERT);
	...
	Print_Text(GString, strlen(GString) - 1, 162, 146, BLANC);
	...
	Print_Text(GString, strlen(GString) - 1, 162, 154, BLANC);
	...
	Print_Text(GString, strlen(GString) - 1, 162, 162, BLANC);
	...
	Print_Text(GString, strlen(GString) - 1, 162, 170, BLANC);
	...
	Print_Text(GString, strlen(GString) - 1, 162, 178, BLANC);
	sprintf(GString, "D7=%.8X PC=%.8X SR=%.4X\n", main68k_context.dreg[7], main68k_context.pc, main68k_context.sr);
	Print_Text(GString, strlen(GString) - 1, 162, 186, BLANC);
	sprintf(GString, "Cycles=%.10d \n", main68k_context.odometer);
	Print_Text(GString, strlen(GString) - 1, 162, 194, BLANC);
	sprintf(GString, "Bank for Z80 = %.8X\n", Bank_Z80);
	Print_Text(GString, strlen(GString) - 1, 162, 202, BLANC);
...
//	Print_Text(GString, strlen(GString) - 1, 162, 210, BLANC);
}
...
void Refresh_S68k_State(void)
{
	...
	Print_Text(Str_Tmp, 22, 196, 130, VERT);
...
void Refresh_VDP_Pattern(void)
{
	...
	Print_Text(Str_Tmp, 29, 28, 0, VERT);

	for(i = 0; i < 24; i++)
	{
		sprintf(GString, "%.4X", (pattern_adr & 0xFFFF) + 0x200 * i);
		Print_Text(GString, strlen(GString), 2, (i << 3) + 11, BLANC);
	}
...
void Refresh_VDP_Palette(void)
{
	...
	Print_Text(Str_Tmp, 29, 180, 0, ROUGE);
	...
	Print_Text(Str_Tmp, 29, 180, 60, BLANC);
...
void Refresh_CDC_State(void)
{
	...
	Print_Text(Str_Tmp, 16, 200, 1, VERT);
