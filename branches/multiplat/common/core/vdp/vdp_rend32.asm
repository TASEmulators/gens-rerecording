...
section .bss align=64
	...
	extern Sprite_Over
	extern Mode_555
	extern VLayer0 ;Nitsuja added this
	extern VLayer1 ;Nitsuja added this
	extern VLayer2 ;Nitsuja added this
	extern VLayer3 ;Nitsuja added this
...
%if %1 < 1
	...
	%endif
	test dword [VLayer0], 1 ;Nitsuja added this
	jz near %%Full_Trans ;Nitsuja added this
%else
	test dword [VLayer1], 1 ;Nitsuja added this
	jz near %%Full_Trans ;Nitsuja added this
%endif
...
%macro PUTLINE_P1 2
	...
	test dword [VLayer2], 1 ;Nitsuja added this
	jz near %%Full_Trans ;Nitsuja added this
...
%macro PUTLINE_SPRITE 2
	...
	test dword [VLayer3], 1 ;Nitsuja added this
	jz near %%Full_Trans ;Nitsuja added this
